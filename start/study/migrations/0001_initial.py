    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_bio', models.CharField(blank=True, default='그룹 소개를 50자 이내(한줄)로 작성해주세요', max_length=200, null=True)),
                ('group_goal', models.CharField(blank=True, default='그룹 목표를 50자 이내(한줄)로 작성해주세요', max_length=50, null=True)),
                ('group_rule', models.TextField(blank=True, default='그룹 규칙을 작성해주세요', max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('joined_at', models.DateTimeField(default=datetime.datetime(2019, 5, 1, 11, 0))),
